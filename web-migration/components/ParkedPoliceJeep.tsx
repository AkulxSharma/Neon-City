...
// jeep-shaped exists on SupercarBody. Static decoration only, no physics rig
// — parked fleet dressing at components/PoliceStation.tsx.
...
export function PoliceJeepMesh() {
  return (
    <group position={[0, 0.42, 0]}>
      ...
      {/* roof light bar — static red/blue, matches PoliceCarMesh's livery */}
      ...
      <mesh position={[0.28, 0.98, -0.4]}>
        <boxGeometry args={[0.5, 0.1, 0.28]} />
        <meshBasicMaterial color="#2040ff" />
      </mesh>
      {/* roof rack rails */}
      {[-0.6, 0.6].map((x) => (
